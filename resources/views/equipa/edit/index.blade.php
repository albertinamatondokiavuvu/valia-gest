...
<head>
    <title>Valia.gest Ads - Editar Membro da Valia-gest</title>
    <meta charset="UTF-8" />
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content">
                            <form action="{{ route('equipas.update', $equipa->slug) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="span8">
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <input type="text" class="span12" value="{{ old('nome', $equipa->nome) }}" name="nome" required>
                                            </div>

                                            <div class="control-group">
                                                <label class="control-label">Função</label>
                                                <input type="text" class="span12" name="funcao"
                                                value="{{ old('funcao', $equipa->funcao) }}">
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Descrição</label>
                                                <input type="text" class="span12" name="resumo"
                                                     value="{{ old('resumo', $equipa->resumo) }}">
                                            </div>
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="file-upload">
                                                <div class="control-group">
                                                    ...
                                                    @if($equipa->capa_image)
                                                        <div class="mb-2">
                                                            <img src="{{ asset('storage/' . $equipa->capa_image) }}" 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <select class="span12" name="estado">
                                                    <option value="1" {{ $equipa->estado ? 'selected' : '' }}>Ativo</option>
                                                    <option value="0" {{ !$equipa->estado ? 'selected' : '' }}>Inativo</option>
                                                </select>
                                            </div>
                                        </div>
