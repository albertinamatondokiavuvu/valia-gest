...
<body>
    ...
    <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
        <ul>
            ...
            <li> <a href="{{ route('equipas.index') }}"><i class="icon icon-user"></i> <span>Equipa</span></a> </li>
        </ul>
    </div>
    <div id="content">
        ...
        <div class="container" style="margin-bottom: 13%; margin-top:13%">
            <div class="widget-box">
                <div class="widget-content text-center"> <!-- Centralização geral -->
                    <br>
                    <h1>BEM VINDO AO PORTAL DO VALIA.GEST ADS</h1>
                    <br>
                    
                    <!-- Container Flex para os botões -->
                    <div class="d-flex gap-3 justify-content-center"> 
                        <a href="{{ route('news.index') }}" 
                           class="btn btn-inverse btn-lg text-white px-4">
                            Listar notícias
                        </a>
